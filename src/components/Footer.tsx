  ...
  return (
    ...
    <div className="mx-auto max-w-screen-xl">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-700 dark:text-gray-400">Copyright © 2024 The Linux Foundation®. All rights reserved. The Linux Foundation has registered trademarks and uses trademarks. For a list of trademarks of The Linux Foundation, please see our <a href="https://www.linuxfoundation.org/legal/trademark-usage?__hstc=60185074.7e4d4d975520f071c34ba68bd97fc7d5.1712692106234.1713034469591.1713037286349.5&__hssc=60185074.3.1713037286349&__hsfp=950146127" className="hover:text-pink font-bold">Trademark Usage</a> page. Linux is a registered trademark of Linus Torvalds. <a href="https://www.linuxfoundation.org/legal/privacy-policy?__hstc=60185074.7e4d4d975520f071c34ba68bd97fc7d5.1712692106234.1713034469591.1713037286349.5&__hssc=60185074.4.1713037286349&__hsfp=950146127"className="hover:text-pink font-bold">Privacy Policy</a> and <a href="https://www.linuxfoundation.org/legal/terms?__hstc=60185074.7e4d4d975520f071c34ba68bd97fc7d5.1712692106234.1713034469591.1713037286349.5&__hssc=60185074.5.1713037286349&__hsfp=950146127"className="hover:text-pink font-bold">Terms of Use</a>.
            </span>
            <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                <a href="#" className="text-gray-500 hover:text-blue ">
                ...
                <a href="#" className="text-gray-500 hover:text-pink ">
